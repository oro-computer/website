...
section: "compiler"
order: 260
sourcePath: "compiler/package-distribution.md"
...
- [`src/`](https://github.com/oro-computer/silk/tree/master/src/) is for distributable Silk implementation sources.
- `defs/` is for definition/prototype modules that describe the importable
 public API.
- [`include/`](https://github.com/oro-computer/silk/tree/master/include/) is for C headers, generated or hand-authored.
...
[`src/lib.slk`](https://github.com/oro-computer/silk/blob/master/src/lib.slk) or its single public definition file. The dependency's own
...
2. Keep distributable implementation under [`src/`](https://github.com/oro-computer/silk/tree/master/src/).
...
program, see [`examples/projects/cove/`](https://github.com/oro-computer/silk/tree/master/examples/projects/cove/). It is a static HTTP file
