...
section: "compiler"
order: 275
sourcePath: "compiler/zig-api.md"
...
If your host is C or C++, start with [`libsilk` quickstart](/silk/docs/compiler/libsilk-quickstart/) and [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/). If your host is Zig, this is the primary downstream reference.
...
For wasm targets, see [WASM backend](/silk/docs/compiler/backend-wasm/) and [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/) for the currently supported output subset.
...
- If you instead want to link the compiled static library from C or C++, use [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/).
...
For ABI lowering details of exported `string`, optionals, and structs, read [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/).
...
These correspond directly to the CLI and C ABI surfaces documented in [CLI reference](/silk/docs/compiler/cli-silk/), [Standard library integration](/silk/docs/compiler/stdlib-integration/), and [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/).
...
These knobs matter only for the output kinds that support them. The detailed native-output rules are defined in [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/).
...
- [`libsilk` quickstart](/silk/docs/compiler/libsilk-quickstart/)
- [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/)
- [`libsilk` (7)](/silk/docs/man/libsilk.7/)
- [`silk_compiler` (3)](/silk/docs/man/silk_compiler.3/)
- [`silk_error` (3)](/silk/docs/man/silk_error.3/)
