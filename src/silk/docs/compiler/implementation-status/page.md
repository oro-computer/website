...
section: "compiler"
order: 255
sourcePath: "compiler/implementation-status.md"
...
- **Portable GPU programs**
 ...
 Driver API.
 - [`std::gpu`](/silk/docs/std/gpu/) supplies discovery, buffers, transfers, streams, launch, and
 ...
 - See [GPU execution placement](/silk/docs/language/gpu-execution/), [GPU launch
 blocks](/silk/docs/language/gpu-launch-blocks/), [`std::gpu`](/silk/docs/std/gpu/),
 [target-neutral GPU compilation](/silk/docs/compiler/backend-gpu/), and [Pure-Silk
 CPU/GPU program](/silk/docs/usage/pure-silk-gpu/).
- **WebAssembly targets**
 - `wasm32-unknown-unknown` produces embedder-facing WebAssembly modules.
 - `wasm32-wasi` produces WASI-style entrypoints.
 - See [WebAssembly back-end](/silk/docs/compiler/backend-wasm/) and [Run WASI
 modules in Node](/silk/docs/usage/howto-run-wasi-node/).
- **Platform applications and host tools**
 ...
 supported Apple Silicon hosts. See [Build LumenTrail](/silk/docs/usage/howto-lumen-trail/),
 [`silk-devices(1)`](/silk/docs/man/silk-devices.1/), and
 [`silk-codesign(1)`](/silk/docs/man/silk-codesign.1/).
- **Package and distribution tooling**
 ...
 workflow.
 - See [Package manifests](/silk/docs/compiler/package-manifests/), [Package
 distribution](/silk/docs/compiler/package-distribution/), and
...
- **Diagnostics and documentation tooling**
 ...
 - `silk error`, [`silk guide`](/silk/docs/usage/guide-examples/), `silk doc`, `silk man`, and `silk proto` explain
 ...
 - See [Compiler diagnostics](/silk/docs/compiler/diagnostics/),
 [`silk-repl(1)`](/silk/docs/man/silk-repl.1/),
 [`silk-help(1)`](/silk/docs/man/silk-help.1/),
 [`silk-error(1)`](/silk/docs/man/silk-error.1/),
 [`silk-guide(1)`](/silk/docs/man/silk-guide.1/), and
 [`silk-proto(1)`](/silk/docs/man/silk-proto.1/).
...
- The exact target matrix changes faster than this high-level page, so use:
 - [`silk-targets(1)`](/silk/docs/man/silk-targets.1/) or `silk targets --json`
 - `silk build --list-gpu-targets` for mixed-executable GPU providers
 - [CLI reference](/silk/docs/compiler/cli-silk/)
 - [C99 ABI and `libsilk.a`](/silk/docs/compiler/abi-libsilk/)
...
- `silk error` / [`silk guide`](/silk/docs/usage/guide-examples/) — inspect diagnostics and curated guide entries.
...
1. Look up the reported code in [Compiler diagnostics](/silk/docs/compiler/diagnostics/).
2. Check the feature’s own notes in the language, stdlib, or compiler reference page.
3. Confirm the active target and package/build mode in [CLI reference](/silk/docs/compiler/cli-silk/).
