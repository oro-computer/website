...
section: "compiler"
order: 258
sourcePath: "compiler/libsilk-quickstart.md"
...
For the full ABI contract, see [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/).
...
- Need the full function-by-function ABI contract: [C ABI (`libsilk`)](/silk/docs/compiler/abi-libsilk/)
- Need the public C manpages: [`libsilk` (7)](/silk/docs/man/libsilk.7/), [`silk_compiler` (3)](/silk/docs/man/silk_compiler.3/), [`silk_error` (3)](/silk/docs/man/silk_error.3/)
- Need Zig instead of C: [Zig embedding API](/silk/docs/compiler/zig-api/)
