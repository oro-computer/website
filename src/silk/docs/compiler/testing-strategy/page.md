...
section: "compiler"
order: 272
sourcePath: "compiler/testing-strategy.md"
...
- C test suites should live in a dedicated directory (e.g. [`c-tests/`](https://github.com/oro-computer/silk/tree/master/c-tests/) or similar) and be wired into the build system so they run regularly.
...
- Execution:
 ...
 embedded in Silk source files (see [testing](/silk/docs/language/testing/)), emitting TAP
