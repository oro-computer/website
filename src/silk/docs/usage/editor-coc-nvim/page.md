...
section: "usage"
order: 250
sourcePath: "usage/editor-coc-nvim.md"
...
should stay aligned with the LSP capabilities documented in [lsp silk](/silk/docs/compiler/lsp-silk/).
...
Reference: [LSP protocol and server](/silk/docs/compiler/lsp-silk/).
