...
section: "usage"
order: 240
sourcePath: "usage/cli-examples.md"
...
For the conceptual model, read: [CLI and toolchain](/silk/docs/guides/cli/).
...
Reference: [`silk-format` (1)](/silk/docs/man/silk-format.1/)
...
NVIDIA/CUDA provider. See [Pure-Silk CPU/GPU program](/silk/docs/usage/pure-silk-gpu/)
...
Reference: [Custom stdlib root](/silk/docs/usage/howto-custom-stdlib-root/)
...
Reference: [libsilk (7)](/silk/docs/man/libsilk.7/).
...
References: [`silk-devices(1)`](/silk/docs/man/silk-devices.1/),
