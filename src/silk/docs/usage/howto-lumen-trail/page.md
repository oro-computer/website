...
section: "usage"
order: 247
sourcePath: "usage/howto-lumen-trail.md"
...
This how-to uses [`examples/projects/lumen-trail/`](https://github.com/oro-computer/silk/tree/master/examples/projects/lumen-trail/) to show the current iOS
...
installation. All app sources live under [`src/`](https://github.com/oro-computer/silk/tree/master/src/) inside the example directory.

## Build The Simulator App

From [`examples/projects/lumen-trail/`](https://github.com/oro-computer/silk/tree/master/examples/projects/lumen-trail/):
...
- [`std::algorithms`](/silk/docs/std/algorithms/) for score normalization,
...
- [`std::runtime::build`](/silk/docs/std/runtime-build/) for build kind/mode metadata.
...
[`src/SilkAppModel.h`](https://github.com/oro-computer/silk/blob/master/src/SilkAppModel.h) so Objective-C inputs can compile directly during
