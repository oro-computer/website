...
section: "usage"
order: 233
sourcePath: "usage/tutorials/01-first-program.md"
...
- More workflows: [CLI examples](/silk/docs/usage/cli-examples/)
- Tutorial 2: [Structs and `impl`](/silk/docs/usage/tutorials/02-structs-and-impls/)
