...
section: "usage"
order: 241
sourcePath: "usage/guide-examples.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk guide`](/silk/docs/usage/guide-examples/)

[`silk guide`](/silk/docs/usage/guide-examples/) is the curated example discovery surface for common Silk tasks.
...
- how do I use [`std::task`](/silk/docs/std/task/)?
...
- [`examples/guide/catalog.json`](https://github.com/oro-computer/silk/blob/master/examples/guide/catalog.json)
...
- exact public std symbol queries use generated metadata from shipped [`std/**/*.slk`](https://github.com/oro-computer/silk/blob/master/std/**/*.slk) modules
...
- guide `Docs:` references are rendered as canonical docs URLs such as
 [types](/silk/docs/language/types/)
