...
type checking ([diagnostics](/silk/docs/compiler/diagnostics/), `E2016`). See
[generics](/silk/docs/language/generics/).
...
([diagnostics](/silk/docs/compiler/diagnostics/), `E2016`).
