...
[grammar](/silk/docs/language/grammar/) for exact syntax):
...
- Expression statements: limited to calls, assignments, and increment/decrement
 in the Supported forms ([flow expression statements](/silk/docs/language/flow-expression-statements/)).
- Flow control:
 ...
 - `assert`,
 - `panic` (typed errors),
 - [`match`](/silk/wiki/language/flow-match/) statement (typed errors; see [typed errors](/silk/docs/language/typed-errors/)).
...
in runtime expressions (see [formal verification](/silk/docs/language/formal-verification/) and
[diagnostics](/silk/docs/compiler/diagnostics/), `E2014`).
