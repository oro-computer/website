...
- Typed errors are implemented end-to-end for the current front-end and the
 `linux/x86_64` backends (see [typed errors](/silk/docs/language/typed-errors/)).
...
- In `silk test` builds, failed assertions record a test failure and execution
 ...
 [testing](/silk/docs/language/testing/).
...
- [`examples/feature_errors_recoverable_url_parse.slk`](https://github.com/oro-computer/silk/blob/master/examples/feature_errors_recoverable_url_parse.slk)
...
- Error values exposed through `libsilk.a` should use well-defined C types (e.g. enums or structs) documented in [abi libsilk](/silk/docs/compiler/abi-libsilk/).
...
- See also: [testing](/silk/docs/language/testing/).
