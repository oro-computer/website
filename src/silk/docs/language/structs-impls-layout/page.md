...
- Stack vs heap allocation is specified in [memory model](/silk/docs/language/memory-model/).
...
- The method named `constructor` is treated specially:
 ...
 default constructor exists (see [literals aggregate](/silk/docs/language/literals-aggregate/)),
 - and certain call-argument coercions (see [types](/silk/docs/language/types/)),
