...
section: "language"
order: 30
sourcePath: "language/type-unions.md"
...
- [typed errors](/silk/docs/language/typed-errors/) (unparenthesized `|` in function *signatures*
 is reserved for typed-error contracts),
- [enums](/silk/docs/language/enums/) (general tagged unions with named variants),
- [flow match](/silk/docs/language/flow-match/) ([`match`](/silk/wiki/language/flow-match/) over union values).
