...
section: "language"
order: 25
sourcePath: "language/attributes.md"
...
See [gpu execution](/silk/docs/language/gpu-execution/).
...
through the manual [`std::gpu::launch`](/silk/docs/std/gpu/) API; it cannot call the function as an
...
- Designed as a shared queue-based worker pool (see
 [`src/silk_rt_task_pool.c`](https://github.com/oro-computer/silk/blob/master/src/silk_rt_task_pool.c)).
