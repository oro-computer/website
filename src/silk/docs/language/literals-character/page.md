...
`char` ([types](/silk/docs/language/types/)).
...
If you need multiple characters, use `string` literals ([literals string](/silk/docs/language/literals-string/)).
...
- **Confusing `\xNN` between `char` and `string`**:
 ...
 - for `string`, `\xNN` denotes a raw byte ([literals string](/silk/docs/language/literals-string/)).

## Related Documents

- [types](/silk/docs/language/types/) (primitive `char` and `string`)
- [literals string](/silk/docs/language/literals-string/) (string literals and escape sequences)
- [operators](/silk/docs/language/operators/) (`as` casts for int-like types, including `char`)
