...
small implicit std prelude (see [packages imports exports](/silk/docs/language/packages-imports-exports/)).
...
Currently, `Object[]` is lowered as an array whose element
...
- special-case compiler hooks for specific interfaces (currently
 ...
 [interfaces](/silk/docs/std/interfaces/) and [memory model](/silk/docs/language/memory-model/)).
...
- The implementation does not introduce a general boxed interface
