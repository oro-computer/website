...
([literals character](/silk/docs/language/literals-character/)).
...
- A stable, fully-specified string ABI story across the C boundary beyond what
 is documented in [abi libsilk](/silk/docs/compiler/abi-libsilk/).
...
- [types](/silk/docs/language/types/) (primitive `string` and `char`)
- [literals character](/silk/docs/language/literals-character/) (shared escape spellings)
- [abi libsilk](/silk/docs/compiler/abi-libsilk/) (C ABI string representation)
