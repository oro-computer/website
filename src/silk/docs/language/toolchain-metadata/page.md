...
section: "language"
order: 65
sourcePath: "language/toolchain-metadata.md"
...
- CLI output: [cli silk](/silk/docs/compiler/cli-silk/) and [silk.1](/silk/docs/man/silk.1/) (`silk --version`)
- Conditional compilation: [attributes](/silk/docs/language/attributes/) (`if attr(...) { ... }`)
