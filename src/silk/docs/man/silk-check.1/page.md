...
section: "man"
order: 287
sourcePath: "man/silk-check.1.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk-check(1)`](/silk/docs/man/silk-check.1/) — Parse and Type-Check
...
- [`silk(1)`](/silk/docs/man/silk.1/), [`silk-build(1)`](/silk/docs/man/silk-build.1/), [`silk-graph(1)`](/silk/docs/man/silk-graph.1/)
