---
layout: "silk-docs"
title: "[silk-size(1)](?p=man/silk-size.1) - Inspect Artifact Sizes"
description: "NOTE: This is the Markdown source for the eventual man 1 page for silk size. The roff-formatted manpage should be generated from this content."
docsCollection: "silk"
section: "man"
order: 290
sourcePath: "man/silk-size.1.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk-size(1)`](/silk/docs/man/silk-size.1/) - Inspect Artifact Sizes
...
- [`silk(1)`](/silk/docs/man/silk.1/), [`silk-build(1)`](/silk/docs/man/silk-build.1/), [`silk-targets(1)`](/silk/docs/man/silk-targets.1/)
