...
section: "man"
order: 297
sourcePath: "man/silk-guide.1.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk-guide(1)`](/silk/docs/man/silk-guide.1/) — Search Curated Silk Example Guides

> NOTE: This is the Markdown source for the eventual man 1 page for [`silk guide`](/silk/docs/usage/guide-examples/). The roff-formatted manpage should be generated from this content.
...
[`silk guide`](/silk/docs/usage/guide-examples/) queries an installed SQLite guide database generated from the
curated catalog at [`examples/guide/catalog.json`](https://github.com/oro-computer/silk/blob/master/examples/guide/catalog.json). The seeded corpus is kept
...
By default, [`silk guide`](/silk/docs/usage/guide-examples/) looks for:
...
- Exact public std symbol lookups use generated metadata from shipped [`std/**/*.slk`](https://github.com/oro-computer/silk/blob/master/std/**/*.slk) modules and route to the matching API guide.
