---
layout: "docs"
title: "[silk-man(1)](?p=man/silk-man.1) — View Manpages Derived from Source Docs"
description: "NOTE: This is the Markdown source for the eventual man 1 page for silk man. The roff-formatted manpage should be generated from this content."
docsCollection: "silk"
section: "man"
order: 299
sourcePath: "man/silk-man.1.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk-man(1)`](/silk/docs/man/silk-man.1/) — View Manpages Derived from Source Docs
...
The doc-comment tag semantics are specified in [doc comments](/silk/docs/language/doc-comments/).
...
- Shorthands:
 ...
 `cache`, `check`, `targets`, `graph`, `size`, `test`, `doc`, `man`,
 `guide`, `error`, `proto`, `help`, `lsp`, `cc`, `env`, and
 `format` / `fmt`).
...
- [`silk(1)`](/silk/docs/man/silk.1/), [`silk-doc(1)`](/silk/docs/man/silk-doc.1/)
- [doc comments](/silk/docs/language/doc-comments/)
