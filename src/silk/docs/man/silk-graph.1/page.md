...
section: "man"
order: 289
sourcePath: "man/silk-graph.1.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk-graph(1)`](/silk/docs/man/silk-graph.1/) - Inspect Module Graphs
...
- `origin` - `user`, `package`, or [`std`](https://github.com/oro-computer/silk/tree/master/std),
...
- [`silk(1)`](/silk/docs/man/silk.1/), [`silk-check(1)`](/silk/docs/man/silk-check.1/), [`silk-build(1)`](/silk/docs/man/silk-build.1/), [`silk-targets(1)`](/silk/docs/man/silk-targets.1/)
