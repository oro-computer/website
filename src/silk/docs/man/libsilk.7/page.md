...
section: "man"
order: 302
sourcePath: "man/libsilk.7.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`libsilk(7)`](/silk/docs/man/libsilk.7/) — C99 ABI for the Silk Compiler
...
[`include/silk.h`](https://github.com/oro-computer/silk/blob/master/include/silk.h) wrapper is still shipped for compatibility.

This manpage summarizes the ABI; the normative specification lives at [abi libsilk](/silk/docs/compiler/abi-libsilk/).
...
- and use the hosted ABI specification at
 [abi libsilk](/silk/docs/compiler/abi-libsilk/) when you need the
...
- This overrides `SILK_STD_ROOT` (environment variable) and the [`std/`](https://github.com/oro-computer/silk/tree/master/std/) working-directory default.
- The function:
...
- Enables the same debug build mode as the CLI (`silk --debug` / `-g`) for the
 ...
 verification (see [formal verification](/silk/docs/language/formal-verification/)).
...
- On `linux/x86_64`, when an executable or shared library imports any external
 ...
 modules like [`std::io`](/silk/docs/std/io/) and [`std::fs`](/silk/docs/std/fs/) do not require manually adding libc.
...
- On success of front‑end validation:
 ...
 - one or more trivial constant [`while`](/silk/wiki/language/flow-while/) loops that appear before the
...
- The formatted message is intended for end-user display and follows the standard compiler diagnostic format (error code + optional file/line/column + caret snippet) as specified at [diagnostics](/silk/docs/compiler/diagnostics/).
...
1. Install or vendor:
 - [`include/silk/silk.h`](https://github.com/oro-computer/silk/blob/master/include/silk/silk.h),
 - optionally [`include/silk.h`](https://github.com/oro-computer/silk/blob/master/include/silk.h) as the legacy compatibility wrapper,
 - `libsilk.a`.
...
- On `linux/x86_64`, the compiler can emit native ELF64 executables, objects,
 ...
 in [abi libsilk](/silk/docs/compiler/abi-libsilk/) (structured control flow, helper calls,
...
- On `wasm32-unknown-unknown` and `wasm32-wasi`, executable builds emit `.wasm`
 ...
 [abi libsilk](/silk/docs/compiler/abi-libsilk/) (including multi-module builds, export-only
...
- [`silk(1)`](/silk/docs/man/silk.1/) — Silk language compiler CLI.
- [`silk_abi_get_version(3)`](/silk/docs/man/silk_abi_get_version.3/), [`silk_compiler(3)`](/silk/docs/man/silk_compiler.3/), [`silk_error(3)`](/silk/docs/man/silk_error.3/), [`silk_bytes(3)`](/silk/docs/man/silk_bytes.3/), [`silk_amdgpu_aql_dispatch_packet_build(3)`](/silk/docs/man/silk_amdgpu_aql_dispatch_packet_build.3/)
- [`silk(7)`](/silk/docs/man/silk.7/)
- [abi libsilk](/silk/docs/compiler/abi-libsilk/) — normative ABI spec.
