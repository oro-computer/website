...
section: "man"
order: 301
sourcePath: "man/silk.7.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`silk(7)`](/silk/docs/man/silk.7/) — Silk Toolchain Overview
...
- a CLI entrypoint ([`silk(1)`](/silk/docs/man/silk.1/)),
- an embedding API ([`libsilk(7)`](/silk/docs/man/libsilk.7/) and the `silk_*` functions documented in section 3),
...
- inspection/reporting commands such as `check`, `targets`, `graph`, `size`,
 `error`, `package`, `cache`, `env`, and `format` support `--json` where a
 stable machine-readable result is useful,
- `silk proto` compiles proto3 schema files to Silk modules without invoking
 `protoc`, uses [`std::protobuf`](/silk/docs/std/protobuf/) for wire-format helpers, and can emit complete
...
- [`silk(1)`](/silk/docs/man/silk.1/) (see the `build` command and its notes),
- [cli silk](/silk/docs/compiler/cli-silk/),
- and runnable fixtures under [`tests/silk/`](https://github.com/oro-computer/silk/tree/master/tests/silk/).

## Source Layout

- Silk source files use the `.slk` extension.
- Package builds are driven by a manifest file named `silk.toml` (see [package manifests](/silk/docs/compiler/package-manifests/)).
- The default stdlib implementation is a directory tree rooted at [`std/`](https://github.com/oro-computer/silk/tree/master/std/) and is imported via `import std::...;`.
...
- [overview](/silk/docs/std/overview/) for module inventory and conventions,
- [conventions](/silk/docs/std/conventions/) for ownership and error-handling patterns,
- [cli silk](/silk/docs/compiler/cli-silk/) for stdlib root selection and archive linking behavior.
...
- [diagnostics](/silk/docs/compiler/diagnostics/) (verifier diagnostics)
...
- [`silk-build(1)`](/silk/docs/man/silk-build.1/), [`silk-package(1)`](/silk/docs/man/silk-package.1/), [`silk-cache(1)`](/silk/docs/man/silk-cache.1/), [`silk-check(1)`](/silk/docs/man/silk-check.1/), [`silk-targets(1)`](/silk/docs/man/silk-targets.1/), [`silk-graph(1)`](/silk/docs/man/silk-graph.1/), [`silk-size(1)`](/silk/docs/man/silk-size.1/), [`silk-test(1)`](/silk/docs/man/silk-test.1/), [`silk-doc(1)`](/silk/docs/man/silk-doc.1/), [`silk-man(1)`](/silk/docs/man/silk-man.1/), [`silk-guide(1)`](/silk/docs/man/silk-guide.1/), [`silk-error(1)`](/silk/docs/man/silk-error.1/), [`silk-proto(1)`](/silk/docs/man/silk-proto.1/), [`silk-cc(1)`](/silk/docs/man/silk-cc.1/)
- [`silk_compiler(3)`](/silk/docs/man/silk_compiler.3/), [`silk_error(3)`](/silk/docs/man/silk_error.3/), [`silk_bytes(3)`](/silk/docs/man/silk_bytes.3/), [`silk_abi_get_version(3)`](/silk/docs/man/silk_abi_get_version.3/), [`silk_amdgpu_aql_dispatch_packet_build(3)`](/silk/docs/man/silk_amdgpu_aql_dispatch_packet_build.3/)
