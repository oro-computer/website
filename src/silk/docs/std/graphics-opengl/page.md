...
section: "std"
order: 138
sourcePath: "std/graphics-opengl.md"
...
Source: [`std/graphics/opengl.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/opengl.slk)

This is the exact canonical documentation page for [`std::graphics::opengl`](/silk/docs/std/graphics-opengl/).

## Role

[`std::graphics::opengl`](/silk/docs/std/graphics-opengl/) is a shipped nested module in the Silk standard library.
...
- The shipped source for this module is [`std/graphics/opengl.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/opengl.slk).
- The canonical module name is [`std::graphics::opengl`](/silk/docs/std/graphics-opengl/).
