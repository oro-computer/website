...
section: "std"
order: 124
sourcePath: "std/sqlite.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::sqlite`](/silk/docs/std/sqlite/)

[`std::sqlite`](/silk/docs/std/sqlite/) provides SQLite database
...
When a program imports [`std::sqlite`](/silk/docs/std/sqlite/), `silk build` automatically links the
target-matched built-in `libsqlite3.a` archive from:

- repo builds: [`vendor/lib/<target-layout>/libsqlite3.a`](https://github.com/oro-computer/silk/blob/master/vendor/lib/<target-layout>/libsqlite3.a)
...
This keeps [`std::sqlite`](/silk/docs/std/sqlite/) runnable without requiring `libsqlite3.so.*` at
runtime.
...
- output staging (hosted baseline):
 - [`vendor/deps/sqlite-amalgamation-3510200/`](https://github.com/oro-computer/silk/tree/master/vendor/deps/sqlite-amalgamation-3510200/) (source; ignored),
 - [`vendor/lib/<target-layout>/libsqlite3.a`](https://github.com/oro-computer/silk/blob/master/vendor/lib/<target-layout>/libsqlite3.a) (static library; ignored),
 - [`vendor/include/<target-layout>/sqlite3.h`](https://github.com/oro-computer/silk/blob/master/vendor/include/<target-layout>/sqlite3.h) +
 [`vendor/include/<target-layout>/sqlite3ext.h`](https://github.com/oro-computer/silk/blob/master/vendor/include/<target-layout>/sqlite3ext.h) (headers; ignored).

## Error Model

[`std::sqlite`](/silk/docs/std/sqlite/) uses [`std::result::Result(T, E)`](/silk/docs/std/result/) and optional-error returns for
...
- Borrowed column accessors:
 ...
 statement.
- Copy helpers:
 - `Stmt.column_text_copy` copies into [`std::strings::String`](/silk/docs/std/strings/).
 - `Stmt.column_blob_copy` copies into [`std::buffer::BufferU8`](/silk/docs/std/buffer/).

## Exported API

The current [`std::sqlite`](/silk/docs/std/sqlite/) surface currently lives in [`std/sqlite.slk`](https://github.com/oro-computer/silk/blob/master/std/sqlite.slk) and
provides:
