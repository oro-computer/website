...
section: "std"
order: 142
sourcePath: "std/window.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::window`](/silk/docs/std/window/)

[`std::window`](/silk/docs/std/window/) is the opt-in standard-library windowing facade. Importing and
...
[`std::runtime::*`](/silk/docs/std/runtime/), reference `silk_rt_*` symbols, or pass native
...
The implementation provides target detection, opt-in Apple SDK
...
reaches [`std::window`](/silk/docs/std/window/).
...
[`std::window`](/silk/docs/std/window/) / [`std::window::*`](/silk/docs/std/window/).

The [`std::runtime::window`](/silk/docs/std/runtime-window/) module is the stdlib-owned implementation boundary,
not the application API. It may use target-gated runtime symbols internally,
but callers should use [`std::window`](/silk/docs/std/window/) types and functions.
...
window application imports only [`std::window`](/silk/docs/std/window/):
...
The same program is shipped as [`examples/std_window_app.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_window_app.slk).
...
[`std::runtime::window`](/silk/docs/std/runtime-window/) directly.
...
[`examples/std_window_controls.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_window_controls.slk); it remains open until the user closes the
window.
...
The same pattern is shipped as [`examples/std_macos_metal_window.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_macos_metal_window.slk).
...
[`std::window`](/silk/docs/std/window/), it keeps the requested executable at `-o <output>` and also
...
When reachable code calls the [`std::window`](/silk/docs/std/window/) runtime on host-backed Mach-O
...
When reachable code calls the [`std::window`](/silk/docs/std/window/) runtime on Linux/x86_64, the
...
event loops. [`std::window`](/silk/docs/std/window/) is the higher layer responsible for platform window
