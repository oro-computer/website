...
`std::graphics`. The shipped [`std::window`](/silk/docs/std/window/) module is the opt-in
...
plus [`std::window`](/silk/docs/std/window/). [`std::graphics::metal`](/silk/docs/std/graphics-metal/) now provides a macOS Metal handle
...
- [`std::graphics::opengl`](/silk/docs/std/graphics-opengl/) — generated OpenGL bindings (core OpenGL 4.6).
- [`std::graphics::opengles`](/silk/docs/std/graphics-opengles/) — generated OpenGL ES bindings (core OpenGL ES 3.2).
- [`std::graphics::vulkan`](/silk/docs/std/graphics-vulkan/) — generated Vulkan bindings (core Vulkan 1.3).
- [`std::graphics::metal`](/silk/docs/std/graphics-metal/) — macOS Metal handle API and [`std::window`](/silk/docs/std/window/)
 `CAMetalLayer` context facade.
- [`std::graphics::window`](/silk/docs/std/graphics-window/) — provider-neutral helper for clearing a
 [`std::window`](/silk/docs/std/window/) with the active graphics backend.
...
- The generated outputs are:
 - [`std/graphics/opengl.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/opengl.slk)
 - [`std/graphics/opengles.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/opengles.slk)
 - [`std/graphics/vulkan.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/vulkan.slk)

[`std::graphics::metal`](/silk/docs/std/graphics-metal/) is not generated from a registry. It is a hand-written
macOS facade backed by the bundled runtime and documented in
[graphics metal](/silk/docs/std/graphics-metal/). It exposes typed opaque handles for Metal
...
declarations live under [`std::runtime::graphics::metal`](/silk/docs/std/runtime-graphics-metal/), not in the public
graphics facade.

[`std::graphics::window`](/silk/docs/std/graphics-window/) is also hand-written. It is the current ergonomic
...
[`std::graphics::opengl`](/silk/docs/std/graphics-opengl/), [`std::graphics::opengles`](/silk/docs/std/graphics-opengles/), and
[`std::graphics::vulkan`](/silk/docs/std/graphics-vulkan/) are generated raw SDK binding modules. Their public
...
[`std::graphics::window`](/silk/docs/std/graphics-window/) and [`std::graphics::metal`](/silk/docs/std/graphics-metal/) are different: they are
...
the Metal window helper live under [`std::runtime::graphics::metal`](/silk/docs/std/runtime-graphics-metal/), matching
the [`std::window`](/silk/docs/std/window/) / [`std::runtime::window`](/silk/docs/std/runtime-window/) layering.
...
Reachable calls to [`std::graphics::metal::clear(...)`](/silk/docs/std/graphics-metal/),
[`std::graphics::metal::clear_window(...)`](/silk/docs/std/graphics-metal/), [`std::graphics::metal::create_context(...)`](/silk/docs/std/graphics-metal/),
direct Metal object creation/encoding calls, or
[`std::graphics::window::clear(...)`](/silk/docs/std/graphics-window/) on `macos-aarch64` opt host-backed Mach-O
executable links into:

- `Metal.framework`,
- `QuartzCore.framework`.

The visible-window example also imports [`std::window`](/silk/docs/std/window/), which opts the same
...
1. Pick the backend module:
 - [`std::graphics::opengl`](/silk/docs/std/graphics-opengl/) for a host-owned desktop OpenGL context,
 - [`std::graphics::opengles`](/silk/docs/std/graphics-opengles/) for a host-owned OpenGL ES context,
 - [`std::graphics::vulkan`](/silk/docs/std/graphics-vulkan/) for raw Vulkan handles and function entrypoints.
...
The Silk compiler repository ships host-driven OpenGL examples under [`examples/`](https://github.com/oro-computer/silk/tree/master/examples/):

- [`examples/std_graphics_opengl_triangle.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_graphics_opengl_triangle.slk) exports
 `silk_example_opengl_triangle_frame(width, height)`, which draws one colored
 triangle.
- [`examples/std_graphics_opengl_3d_cube.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_graphics_opengl_3d_cube.slk) exports
 `silk_example_opengl_cube_frame(width, height, time_seconds)`, which draws an
 animated perspective cube.
- [`examples/std_graphics_opengl_mouse_reactive.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_graphics_opengl_mouse_reactive.slk) exports
