...
section: "std"
order: 157
sourcePath: "std/crypto-hash.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::crypto::hash`](/silk/docs/std/crypto-hash/)

Source: [`std/crypto/hash.slk`](https://github.com/oro-computer/silk/blob/master/std/crypto/hash.slk)

This is the exact canonical documentation page for [`std::crypto::hash`](/silk/docs/std/crypto-hash/).

## Role

[`std::crypto::hash`](/silk/docs/std/crypto-hash/) is a shipped nested module in the Silk standard library.
