...
section: "std"
order: 192
sourcePath: "std/runtime-posix-dylib.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::runtime::posix::dylib`](/silk/docs/std/runtime-posix-dylib/)

[`std::runtime::posix::dylib`](/silk/docs/std/runtime-posix-dylib/) is the hosted POSIX dynamic-loader backend for
[`std::runtime::dylib`](/silk/docs/std/runtime-dylib/).

It binds the bundled C runtime shim in [`src/silk_rt_dylib.c`](https://github.com/oro-computer/silk/blob/master/src/silk_rt_dylib.c), which calls the
...
Downstream applications should use [`std::dylib`](/silk/docs/std/dylib/), which owns the public result,
