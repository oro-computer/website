...
section: "std"
order: 105
sourcePath: "std/unicode.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::unicode`](/silk/docs/std/unicode/)
...
[types](/silk/docs/language/types/)). A `string` is a length-tracked UTF-8 byte sequence.
Converting `char` values into a `string` or [`std::strings::String`](/silk/docs/std/strings/) requires
...
- [types](/silk/docs/language/types/) (`char`)
- [literals string](/silk/docs/language/literals-string/) (`string` as UTF-8 bytes)
- [strings](/silk/docs/std/strings/) (`String.from_chars` and `StringBuilder.push_char`)
- [regex](/silk/docs/std/regex/) (regex literals and matching)
