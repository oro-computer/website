...
and byte-order helper subset is implemented in [`std/bits.slk`](https://github.com/oro-computer/silk/blob/master/std/bits.slk) for the current
backend subset.

[`std::bits`](/silk/docs/std/bits/) provides common bit “twiddling” helpers:
...
- [operators](/silk/docs/language/operators/) (bitwise operators and shift semantics)
- [networking](/silk/docs/std/networking/) ([`std::net`](/silk/docs/std/networking/) byte-order helpers built on the hosted baseline)
