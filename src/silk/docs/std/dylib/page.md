...
[`std::dylib`](/silk/docs/std/dylib/) is the opt-in standard-library facade for loading dynamic
...
- On `linux/x86_64`, importing [`std::dylib`](/silk/docs/std/dylib/) automatically adds the libc
...
See [`examples/std_dylib_strlen.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_dylib_strlen.slk) for the runnable version.
...
See [`examples/std_dylib_errors.slk`](https://github.com/oro-computer/silk/blob/master/examples/std_dylib_errors.slk) for a runnable failure-path example.
...
- On Linux, ensure the target system has the library you open and that the path
 or loader search path is correct. [`std::dylib`](/silk/docs/std/dylib/) adds the libc component needed
...
- [howto dynamic libraries](/silk/docs/usage/howto-dynamic-libraries/)
- [ext](/silk/docs/language/ext/)
- [operators](/silk/docs/language/operators/)

## Implementation

[`std::dylib`](/silk/docs/std/dylib/) delegates to [`std::runtime::dylib`](/silk/docs/std/runtime-dylib/), which delegates to
[`std::runtime::posix::dylib`](/silk/docs/std/runtime-posix-dylib/) in the shipped hosted stdlib. The C runtime shim is
implemented in [`src/silk_rt_dylib.c`](https://github.com/oro-computer/silk/blob/master/src/silk_rt_dylib.c) and is statically linked as part of the
