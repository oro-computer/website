...
section: "std"
order: 139
sourcePath: "std/graphics-opengles.md"
...
Source: [`std/graphics/opengles.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/opengles.slk)

This is the exact canonical documentation page for [`std::graphics::opengles`](/silk/docs/std/graphics-opengles/).

## Role

[`std::graphics::opengles`](/silk/docs/std/graphics-opengles/) is a shipped nested module in the Silk standard library.
...
- [graphics](/silk/docs/std/graphics/)

## Notes

- The shipped source for this module is [`std/graphics/opengles.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/opengles.slk).
- The canonical module name is [`std::graphics::opengles`](/silk/docs/std/graphics-opengles/).
