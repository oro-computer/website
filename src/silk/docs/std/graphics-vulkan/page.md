...
section: "std"
order: 140
sourcePath: "std/graphics-vulkan.md"
...
Source: [`std/graphics/vulkan.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/vulkan.slk)

This is the exact canonical documentation page for [`std::graphics::vulkan`](/silk/docs/std/graphics-vulkan/).

## Role

[`std::graphics::vulkan`](/silk/docs/std/graphics-vulkan/) is a shipped nested module in the Silk standard library.
...
- The shipped source for this module is [`std/graphics/vulkan.slk`](https://github.com/oro-computer/silk/blob/master/std/graphics/vulkan.slk).
- The canonical module name is [`std::graphics::vulkan`](/silk/docs/std/graphics-vulkan/).
