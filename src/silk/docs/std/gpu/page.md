...
section: "std"
order: 132
sourcePath: "std/gpu.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::gpu`](/silk/docs/std/gpu/)

[`std::gpu`](/silk/docs/std/gpu/) is the public host-side API for pure-Silk GPU discovery, device
...
See [gpu execution](/silk/docs/language/gpu-execution/) for placement rules and
[gpu device](/silk/docs/std/gpu-device/) for the semantic device-operation surface.
