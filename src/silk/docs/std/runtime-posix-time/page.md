...
section: "std"
order: 203
sourcePath: "std/runtime-posix-time.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::runtime::posix::time`](/silk/docs/std/runtime-posix-time/)

Source: [`std/runtime/posix/time.slk`](https://github.com/oro-computer/silk/blob/master/std/runtime/posix/time.slk)

This is the exact canonical documentation page for [`std::runtime::posix::time`](/silk/docs/std/runtime-posix-time/).

## Role

[`std::runtime::posix::time`](/silk/docs/std/runtime-posix-time/) is an implementation-facing runtime module in the shipped [`std/**`](https://github.com/oro-computer/silk/tree/master/std/**) tree.
...
- The shipped source for this module is [`std/runtime/posix/time.slk`](https://github.com/oro-computer/silk/blob/master/std/runtime/posix/time.slk).
- The canonical module name is [`std::runtime::posix::time`](/silk/docs/std/runtime-posix-time/).
