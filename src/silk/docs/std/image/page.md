...
- [`std::image::color`](/silk/docs/std/image-color/) — color value types and conversion helpers (pure Silk),
- [`std::image::png`](/silk/docs/std/image-png/) — PNG decode/encode backed by libpng,
- [`std::image::jpeg`](/silk/docs/std/image-jpeg/) — JPEG decode/encode backed by libjpeg-turbo.
...
- [`std::image::color`](/silk/docs/std/image-color/) — Go-inspired color model helpers and common color value
 types.
- [`std::image::png`](/silk/docs/std/image-png/) — PNG decode/encode (`RGBA8`) via libpng.
- [`std::image::jpeg`](/silk/docs/std/image-jpeg/) — JPEG decode/encode (`RGBA8`) via libjpeg-turbo.
...
[`std::image::png`](/silk/docs/std/image-png/) / [`std::image::jpeg`](/silk/docs/std/image-jpeg/) are present in the module set, and also
