...
section: "std"
order: 126
sourcePath: "std/test.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::test`](/silk/docs/std/test/)
...
language-level `assert` behavior in test builds ([testing](/silk/docs/language/testing/)).

Each helper also carries a Formal Silk contract requiring `BUILD_MODE == "test"`
via [`std::test::requires_test_mode()`](/silk/docs/std/test/) so downstream verification can model
