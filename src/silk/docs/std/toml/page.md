...
section: "std"
order: 98
sourcePath: "std/toml.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::toml`](/silk/docs/std/toml/)

[`std::toml`](/silk/docs/std/toml/) provides a TOML v1.0-style parser plus deterministic emission over
an index-based DOM.
...
- The internal DOM storage now uses a private
 [`std::toml::dom_storage_well_formed(...)`](/silk/docs/std/toml/) theory defined inside
 [`std/toml.slk`](https://github.com/oro-computer/silk/blob/master/std/toml.slk), and the public document accessors attach that local contract
 directly.
...
- Rich datetime parsing and integration with [`std::temporal`](/silk/docs/std/temporal/).
