...
section: "std"
order: 185
sourcePath: "std/runtime-graphics-metal.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::runtime::graphics::metal`](/silk/docs/std/runtime-graphics-metal/)

[`std::runtime::graphics::metal`](/silk/docs/std/runtime-graphics-metal/) is the low-level runtime boundary used by
[`std::graphics::metal`](/silk/docs/std/graphics-metal/). It is not the application API; application code should
import [`std::graphics::metal`](/silk/docs/std/graphics-metal/) or [`std::graphics::window`](/silk/docs/std/graphics-window/) instead.
...
[`src/silk_rt_metal.c`](https://github.com/oro-computer/silk/blob/master/src/silk_rt_metal.c). This module is the only stdlib source that declares
those symbols.
...
public [`std::graphics::metal`](/silk/docs/std/graphics-metal/) and [`std::graphics::window`](/silk/docs/std/graphics-window/) facades without
