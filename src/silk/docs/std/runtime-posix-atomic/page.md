...
section: "std"
order: 191
sourcePath: "std/runtime-posix-atomic.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::runtime::posix::atomic`](/silk/docs/std/runtime-posix-atomic/)

[`std::runtime::posix::atomic`](/silk/docs/std/runtime-posix-atomic/) is the hosted POSIX implementation module for
...
[`src/silk_rt_atomic.c`](https://github.com/oro-computer/silk/blob/master/src/silk_rt_atomic.c), then re-exports narrow wrappers for
[`std::runtime::atomic`](/silk/docs/std/runtime-atomic/).
...
[`std::atomic`](/silk/docs/std/atomic/) layer. Runtime helpers still sanitize invalid load/store/failure
