...
section: "std"
order: 89
sourcePath: "std/number.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::number`](/silk/docs/std/number/)
...
- formatting numeric values into owned [`std::strings::String`](/silk/docs/std/strings/) outputs.
...
Formatting functions allocate and return owned [`std::strings::String`](/silk/docs/std/strings/) values.
...
- [strings](/silk/docs/std/strings/) (owned `String`)
- [literals numeric](/silk/docs/language/literals-numeric/) (numeric literal syntax)
- [boxed values](/silk/docs/std/boxed-values/) (boxed primitive design)
