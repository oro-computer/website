...
section: "std"
order: 79
sourcePath: "std/bytes.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::bytes`](/silk/docs/std/bytes/)

[`std::bytes`](/silk/docs/std/bytes/) is the byte-oriented facade for allocation-free work over borrowed
memory. It reuses [`std::arrays::ByteSlice`](/silk/docs/std/arrays/) as the concrete slice type and gives
...
## Relationship To [`std::arrays`](/silk/docs/std/arrays/)

[`std::arrays::ByteSlice`](/silk/docs/std/arrays/) remains the canonical packed-byte view type used by
existing OS/FFI APIs. [`std::bytes::ByteSlice`](/silk/docs/std/bytes/) is an alias plus a focused
