...
section: "std"
order: 225
sourcePath: "std/runtime-window.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::runtime::window`](/silk/docs/std/runtime-window/)

[`std::runtime::window`](/silk/docs/std/runtime-window/) is the low-level runtime boundary used by
[`std::window`](/silk/docs/std/window/). It is not intended as the ergonomic application API; import
[`std::window`](/silk/docs/std/window/) or a platform facade under [`std::window::*`](/silk/docs/std/window/) instead.
...
keeps [`std::window`](/silk/docs/std/window/) usable for capability checks and unsupported-open handling
...
[`std::window`](/silk/docs/std/window/) iOS executables by materializing an adjacent `<output>.app`
bundle.
