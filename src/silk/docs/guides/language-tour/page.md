...
section: "guides"
order: 3
sourcePath: "guides/language-tour.md"
...
## Enums and [`match`](/silk/wiki/language/flow-match/)

Enums model “one of several shapes” and are commonly used with [`match`](/silk/wiki/language/flow-match/).
...
[`match`](/silk/wiki/language/flow-match/) is also the natural way to handle results and typed errors (next sections).
...
Callers typically handle results with [`match`](/silk/wiki/language/flow-match/):
...
Then handle it explicitly with [`match`](/silk/wiki/language/flow-match/):
...
Next: [Modules & packages](/silk/docs/guides/modules-and-packages/) · [Standard library](/silk/docs/guides/standard-library/) ·
