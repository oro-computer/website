...
section: "guides"
order: 2
sourcePath: "guides/hello-world.md"
...
Next: [CLI and toolchain](/silk/docs/guides/cli/)
...
small [`std::args`](/silk/docs/std/args/) helper so you can treat raw `argv` pointers as `string` views.
...
Reference: [`std::fs`](/silk/docs/std/filesystem/)
...
Reference: [`std::net`](/silk/docs/std/networking/), [`std::http`](/silk/docs/std/http/)
...
Reference: [`std::crypto`](/silk/docs/std/crypto/)

### GGML

[`std::ggml`](/silk/docs/std/ggml/) brings the ggml tensor library into the standard library surface. On the hosted baseline, the toolchain
...
Reference: [`std::ggml`](/silk/docs/std/ggml/)
...
Reference: [`std::graphics`](/silk/docs/std/graphics/)
...
Reference: [Concurrency](/silk/docs/language/concurrency/), [Tutorial 5](/silk/docs/usage/tutorials/05-concurrency/)
...
Reference: [Formal Silk guide](/silk/docs/guides/formal-silk/), [Formal Silk reference](/silk/docs/language/formal-verification/), [`while` loop](/silk/docs/language/flow-while/), [Syntax tour](/silk/docs/language/syntax-tour/)
...
Reference: [How-To: Run `wasm32-wasi` Output in Node.js](/silk/docs/usage/howto-run-wasi-node/)

## Where to go next

- [Language tour](/silk/docs/guides/language-tour/)
- [Modules & packages](/silk/docs/guides/modules-and-packages/)
- [Standard library](/silk/docs/guides/standard-library/)
- Tutorials: [Filesystem](/silk/docs/usage/tutorials/04-filesystem/), [Concurrency](/silk/docs/usage/tutorials/05-concurrency/)
- [WASI + Node](/silk/docs/usage/howto-run-wasi-node/)
- [Formal Silk](/silk/docs/language/formal-verification/)
