...
That maps directly to `attr(feature="...")` queries in the language reference. See [Attributes](/silk/docs/language/attributes/).
...
same executable. See [Target-neutral GPU compilation](/silk/docs/compiler/backend-gpu/)
and [Pure-Silk CPU/GPU program](/silk/docs/usage/pure-silk-gpu/).
...
See [Package manifests](/silk/docs/compiler/package-manifests/), [Package distribution](/silk/docs/compiler/package-distribution/), and
...
[`silk-devices(1)`](/silk/docs/man/silk-devices.1/),
[`silk-codesign(1)`](/silk/docs/man/silk-codesign.1/), and [Build LumenTrail for
iOS](/silk/docs/usage/howto-lumen-trail/).
...
- [`silk-doc` (1)](/silk/docs/man/silk-doc.1/)
- [`silk-man` (1)](/silk/docs/man/silk-man.1/)
- [`silk-guide` (1)](/silk/docs/man/silk-guide.1/)
- [`silk-error` (1)](/silk/docs/man/silk-error.1/)
- [`silk-env` (1)](/silk/docs/man/silk-env.1/)
- [`silk-format` (1)](/silk/docs/man/silk-format.1/)
- [`silk-help` (1)](/silk/docs/man/silk-help.1/)
- [`silk-targets` (1)](/silk/docs/man/silk-targets.1/)
- [`silk-graph` (1)](/silk/docs/man/silk-graph.1/)
- [`silk-size` (1)](/silk/docs/man/silk-size.1/)
...
- [Zig embedding API](/silk/docs/compiler/zig-api/)
...
Reference: [Compiler diagnostics](/silk/docs/compiler/diagnostics/)

## Next

- [Testing](/silk/docs/guides/testing/)
- [Formal Silk](/silk/docs/guides/formal-silk/)
