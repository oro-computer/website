...
section: "guides"
order: 5
sourcePath: "guides/project-dependencies.md"
...
installed package root. The [`examples/projects/cove/`](https://github.com/oro-computer/silk/tree/master/examples/projects/cove/) project in the Silk
