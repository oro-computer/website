...
in the same place as the code. From here, continue with [Hello world](/silk/docs/guides/hello-world/), then the
[Language tour](/silk/docs/guides/language-tour/), [Modules, packages, and publication](/silk/docs/guides/modules-and-packages/), and
