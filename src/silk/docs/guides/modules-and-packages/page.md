...
section: "guides"
order: 4
sourcePath: "guides/modules-and-packages.md"
...
cases, use [Packages, Imports, and Exports](/silk/docs/language/packages-imports-exports/).
...
- [`src/`](https://github.com/oro-computer/silk/tree/master/src/) contains implementation modules.
- `defs/` contains prototype/interface modules for public ABI or binary package
 consumers.
- [`examples/`](https://github.com/oro-computer/silk/tree/master/examples/) contains copyable downstream examples.
- [`tests/`](https://github.com/oro-computer/silk/tree/master/tests/) contains package-local tests.
...
- [`std/io`](https://github.com/oro-computer/silk/tree/master/std/io) resolves from the configured stdlib root.
...
[`std::runtime::globals`](/silk/docs/std/runtime-globals/). That module exposes a small prelude with `using`
...
importing [`std/result`](https://github.com/oro-computer/silk/tree/master/std/result) only to reach the defining module.
...
- `silk.toml`
- [`src/**`](https://github.com/oro-computer/silk/tree/master/src/**) for source packages
...
- [Project dependencies](/silk/docs/guides/project-dependencies/)
- [Practical logger module walkthrough](/silk/docs/guides/practical-logger-module/)
