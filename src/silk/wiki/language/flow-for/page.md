...
Full reference: [flow for](/silk/wiki/language/flow-for/).

## Notes

- Supported forms + Limitations: [flow for](/silk/wiki/language/flow-for/)
...
- Full reference: [flow for](/silk/wiki/language/flow-for/)
- Iterator protocol (Supported forms): [interfaces](/silk/wiki/std/interfaces/)
