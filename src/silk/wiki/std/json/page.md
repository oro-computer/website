...
section: "std"
order: 70
sourcePath: "std/json.md"
githubRepo: "oro-computer/silk"
githubRef: "master"
---

# [`std::json`](/silk/docs/std/json/)

[`std::json`](/silk/docs/std/json/) provides JSON parsing and stringifying (implementation + expanded
subset).

Full reference: [json](/silk/wiki/std/json/).
...
- [`std::json::number_as_i64(doc: &Document, id: i64) -> i64?`](/silk/docs/std/json/)
- [`std::json::stringify(doc: &Document, id: i64) -> std::result::Result(std::strings::String, std::memory::OutOfMemory)`](/silk/docs/std/json/)
- [`std::json::stringify_pretty(doc: &Document, id: i64, indent: int) -> std::result::Result(std::strings::String, std::memory::OutOfMemory)`](/silk/docs/std/json/)
