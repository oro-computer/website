...
[`std::url`](/silk/docs/std/url/) provides a WHATWG URL parser/serializer and `URLSearchParams`-style
behavior.

Full reference: [url](/silk/wiki/std/url/).
...
- [`std::url::parse(input: string) -> URLResult`](/silk/docs/std/url/)
- [`std::url::parse_with_base(input: string, base: &URL) -> URLResult`](/silk/docs/std/url/)
