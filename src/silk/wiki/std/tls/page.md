...
[`std::tls`](/silk/docs/std/tls/) provides TLS client/server primitives (hosted baseline via mbedTLS).

Full reference: [tls](/silk/wiki/std/tls/).
...
as [`tests/silk/pass_std_tls_mem_handshake.slk`](https://github.com/oro-computer/silk/blob/master/tests/silk/pass_std_tls_mem_handshake.slk).
