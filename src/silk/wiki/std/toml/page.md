...
[`std::toml`](/silk/docs/std/toml/) provides TOML parsing (implementation + expanded subset).

Full reference: [toml](/silk/wiki/std/toml/).
...
- [`std::toml::int_as_i64(doc: &Document, id: i64) -> i64?`](/silk/docs/std/toml/)
