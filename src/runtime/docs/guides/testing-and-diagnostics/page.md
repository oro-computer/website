...
section: "guides"
order: 21
sourcePath: "guides/testing-and-diagnostics.md"
...
## 2) Run the tests through [`oroc`](/runtime/docs/cli/oroc/)
...
Use plain [`oro:test`](/runtime/docs/javascript/test/) assertions for:
...
- [Worker threads for heavy work](/runtime/docs/guides/worker-threads-for-heavy-work/)
- [MCP and agent automation](/runtime/docs/guides/mcp-and-agent-automation/)
- [`oro:test`](/runtime/docs/javascript/test/) · [`oro:diagnostics`](/runtime/docs/javascript/diagnostics/)
