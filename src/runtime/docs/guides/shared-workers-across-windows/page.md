...
section: "guides"
order: 13
sourcePath: "guides/shared-workers-across-windows.md"
...
[`oro:application`](/runtime/docs/javascript/application/) handles window creation. The shared worker keeps those windows consistent:
...
- [`oro:shared-worker`](/runtime/docs/javascript/shared-worker/)
