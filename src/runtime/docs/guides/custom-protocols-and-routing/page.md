...
section: "guides"
order: 15
sourcePath: "guides/custom-protocols-and-routing.md"
...
[`oro:protocol-handlers`](/runtime/docs/javascript/protocol-handlers/) lets you ask the runtime which service-worker registration is currently bound to a scheme:
