...
section: "guides"
order: 19
sourcePath: "guides/mobile-targets-and-device-installs.md"
...
- Use [`oroc list-devices`](/runtime/docs/cli/list-devices/) before [`oroc install-app`](/runtime/docs/cli/install-app/) on shared lab machines.
- Treat simulator convenience separately from production packaging.

## Next

- [Build and package](/runtime/docs/guides/build-and-package/)
- [Release packaging and signed updates](/runtime/docs/guides/release-packaging-and-signed-updates/)
- [`oroc setup`](/runtime/docs/cli/setup/) · [`oroc list-devices`](/runtime/docs/cli/list-devices/) · [`oroc install-app`](/runtime/docs/cli/install-app/)
