...
- opens a second native window through [`oro:application`](/runtime/docs/javascript/application/),
- raises a desktop notification through [`oro:notification`](/runtime/docs/javascript/notification/).
...
- [`oro:application`](/runtime/docs/javascript/application/) can inspect and control native windows,
- [`oro:notification`](/runtime/docs/javascript/notification/) reaches the host notification system,
...
For quick experiments, [`oroc`](/runtime/docs/cli/oroc/) can infer a minimal configuration when no `oro.toml` is present:
...
- CLI: [oroc run](/runtime/docs/cli/run/) · [oroc build](/runtime/docs/cli/build/)
- Config: [Overview](/runtime/docs/config/overview/)
- JavaScript APIs: [Overview](/runtime/docs/javascript/overview/) · [`oro:application`](/runtime/docs/javascript/application/)
