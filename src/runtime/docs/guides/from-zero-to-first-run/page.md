...
section: "guides"
order: 1
sourcePath: "guides/from-zero-to-first-run.md"
...
## 1) Create a project with [`oroc init`](/runtime/docs/cli/init/)
...
- [`oro:application`](/runtime/docs/javascript/application/) is available from the main window,
...
- [Hello world](/runtime/docs/guides/hello-world/)
- [Configure your runtime project](/runtime/docs/guides/configure-your-runtime-project/)
- [Project layout](/runtime/docs/guides/project-layout/)
