...
section: "guides"
order: 4
sourcePath: "guides/configure-your-runtime-project.md"
...
## 4) Use [`copy_map`](/runtime/docs/config/copy-map/) to define your bundle

[`copy_map`](/runtime/docs/config/copy-map/) is where you decide what becomes part of the application bundle:
...
- [Files and sandboxing](/runtime/docs/guides/files-and-sandboxing/)
