...
section: "guides"
order: 10
sourcePath: "guides/secure-storage-and-sessions.md"
...
SQLite. Put refresh tokens, client secrets, and other credentials in [`oro:secure-storage`](/runtime/docs/javascript/secure-storage/).
