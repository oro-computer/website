...
section: "cli"
order: 42
sourcePath: "cli/update/validate.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oroc update validate`](/runtime/docs/cli/update/validate/)
...
- Validation is aligned with [`schemas/update-manifest.schema.json`](https://github.com/oro-computer/runtime/blob/master/schemas/update-manifest.schema.json).
...
- [`oroc update init`](/runtime/docs/cli/update/init/)
