...
section: "javascript"
order: 126
sourcePath: "javascript/vm.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:vm`](/runtime/docs/javascript/vm/)

[`oro:vm`](/runtime/docs/javascript/vm/) runs JavaScript in isolated runtime contexts and manages context windows and workers.
