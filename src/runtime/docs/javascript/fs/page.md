...
section: "javascript"
order: 55
sourcePath: "javascript/fs.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:fs`](/runtime/docs/javascript/fs/)

[`oro:fs`](/runtime/docs/javascript/fs/) provides filesystem APIs modeled on POSIX and Node.js.
...
- [Config reference](/runtime/docs/config/reference/)
