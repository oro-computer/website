...
section: "javascript"
order: 128
sourcePath: "javascript/worker.md"
...
[`oro:worker`](/runtime/docs/javascript/worker/) re-exports the runtime worker classes for dedicated, shared, and service workers.

## Related guides

- [Worker threads for heavy work](/runtime/docs/guides/worker-threads-for-heavy-work/)
- [Shared workers across windows](/runtime/docs/guides/shared-workers-across-windows/)
