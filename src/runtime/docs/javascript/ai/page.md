...
section: "javascript"
order: 59
sourcePath: "javascript/ai.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:ai`](/runtime/docs/javascript/ai/)

[`oro:ai`](/runtime/docs/javascript/ai/) exposes local AI helpers. It currently exports two modules:
