...
section: "javascript"
order: 53
sourcePath: "javascript/window.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:window`](/runtime/docs/javascript/window/)

[`oro:window`](/runtime/docs/javascript/window/) provides the `ApplicationWindow` class and window-specific methods.

You typically do not import this module directly—get window instances via [`oro:application`](/runtime/docs/javascript/application/):
