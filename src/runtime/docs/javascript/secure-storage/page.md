...
section: "javascript"
order: 56
sourcePath: "javascript/secure-storage.md"
...
[`oro:secure-storage`](/runtime/docs/javascript/secure-storage/) stores secrets scoped by origin (for example tokens, credentials, API keys).
