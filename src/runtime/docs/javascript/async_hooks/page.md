...
section: "javascript"
order: 62
sourcePath: "javascript/async_hooks.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:async_hooks`](/runtime/docs/javascript/async_hooks/)

[`oro:async_hooks`](/runtime/docs/javascript/async_hooks/) exposes hook-based async lifecycle inspection compatible with Node-style instrumentation.
