...
section: "javascript"
order: 104
sourcePath: "javascript/os.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:os`](/runtime/docs/javascript/os/)

[`oro:os`](/runtime/docs/javascript/os/) exposes platform, CPU, temporary-directory, and system metadata helpers.
