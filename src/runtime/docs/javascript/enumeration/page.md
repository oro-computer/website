...
section: "javascript"
order: 80
sourcePath: "javascript/enumeration.md"
...
[`oro:enumeration`](/runtime/docs/javascript/enumeration/) is a small typed-set helper used throughout the runtime surface.
