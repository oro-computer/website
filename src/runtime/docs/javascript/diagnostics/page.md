...
section: "javascript"
order: 77
sourcePath: "javascript/diagnostics.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:diagnostics`](/runtime/docs/javascript/diagnostics/)

[`oro:diagnostics`](/runtime/docs/javascript/diagnostics/) exposes channels, metrics, and runtime/window diagnostic queries.
