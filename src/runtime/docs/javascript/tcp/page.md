...
[`oro:tcp`](/runtime/docs/javascript/tcp/) exposes lower-level TCP client and server helpers alongside the higher-level [`oro:net`](/runtime/docs/javascript/net/) API.
