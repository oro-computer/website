...
section: "javascript"
order: 54
sourcePath: "javascript/hooks.md"
...
[`oro:hooks`](/runtime/docs/javascript/hooks/) provides a consistent way to subscribe to runtime-delivered lifecycle and system events.
