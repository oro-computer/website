...
section: "javascript"
order: 63
sourcePath: "javascript/async.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:async`](/runtime/docs/javascript/async/)

[`oro:async`](/runtime/docs/javascript/async/) exposes async context propagation, deferred values, and resource tracking primitives.
