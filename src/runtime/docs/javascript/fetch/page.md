...
section: "javascript"
order: 85
sourcePath: "javascript/fetch.md"
...
[`oro:fetch`](/runtime/docs/javascript/fetch/) exposes the runtime fetch stack and standard request/response primitives.

## Related guides

- [Calling HTTP APIs](/runtime/docs/guides/calling-http-apis/)
