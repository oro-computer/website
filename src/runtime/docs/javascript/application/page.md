...
section: "javascript"
order: 52
sourcePath: "javascript/application.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:application`](/runtime/docs/javascript/application/)

[`oro:application`](/runtime/docs/javascript/application/) exposes application-level APIs: creating windows, querying windows, menus, and runtime metadata.
