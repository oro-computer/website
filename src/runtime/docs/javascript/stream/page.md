...
section: "javascript"
order: 114
sourcePath: "javascript/stream.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:stream`](/runtime/docs/javascript/stream/)

[`oro:stream`](/runtime/docs/javascript/stream/) exposes Node-style streams, Web streams, and pipeline helpers.
