...
section: "javascript"
order: 115
sourcePath: "javascript/string_decoder.md"
...
[`oro:string_decoder`](/runtime/docs/javascript/string_decoder/) decodes split byte streams into text without corrupting multibyte characters.
