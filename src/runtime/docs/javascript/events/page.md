...
section: "javascript"
order: 83
sourcePath: "javascript/events.md"
...
[`oro:events`](/runtime/docs/javascript/events/) provides `EventEmitter`, `EventTarget`, and event primitives used across the runtime.
