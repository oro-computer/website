...
section: "javascript"
order: 107
sourcePath: "javascript/protocol-handlers.md"
...
[`oro:protocol-handlers`](/runtime/docs/javascript/protocol-handlers/) exposes runtime helpers for custom protocol and service-worker routing.

## Related guides

- [Custom protocols and routing](/runtime/docs/guides/custom-protocols-and-routing/)
