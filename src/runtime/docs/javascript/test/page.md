...
section: "javascript"
order: 118
sourcePath: "javascript/test.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:test`](/runtime/docs/javascript/test/)

[`oro:test`](/runtime/docs/javascript/test/) provides the runtime test harness used by application and module tests.
