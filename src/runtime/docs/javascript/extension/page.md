...
section: "javascript"
order: 84
sourcePath: "javascript/extension.md"
...
[`oro:extension`](/runtime/docs/javascript/extension/) loads app-bundled native extensions and Wasm extensions, then exposes their registered runtime state to
JavaScript.
...
- [Native extensions](/runtime/docs/guides/native-extensions/)
...
- app code loads the extension with [`oro:extension`](/runtime/docs/javascript/extension/) and talks to those routes with [`oro:ipc`](/runtime/docs/javascript/ipc/),
