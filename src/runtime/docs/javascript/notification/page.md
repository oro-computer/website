...
section: "javascript"
order: 57
sourcePath: "javascript/notification.md"
...
[`oro:notification`](/runtime/docs/javascript/notification/) provides an API to display desktop and mobile notifications and request permission to use them.
...
The runtime also emits global notification events through [`oro:hooks`](/runtime/docs/javascript/hooks/):
