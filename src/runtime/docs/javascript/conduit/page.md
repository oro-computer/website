...
section: "javascript"
order: 70
sourcePath: "javascript/conduit.md"
...
[`oro:conduit`](/runtime/docs/javascript/conduit/) manages the runtime WebSocket conduit used for internal cross-surface messaging.
