...
section: "javascript"
order: 98
sourcePath: "javascript/mime.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:mime`](/runtime/docs/javascript/mime/)

[`oro:mime`](/runtime/docs/javascript/mime/) looks up MIME types, extensions, and content-type metadata.
