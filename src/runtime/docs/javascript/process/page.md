...
section: "javascript"
order: 106
sourcePath: "javascript/process.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:process`](/runtime/docs/javascript/process/)

[`oro:process`](/runtime/docs/javascript/process/) exposes runtime process state, env access, signals, and scheduling helpers.
