...
section: "javascript"
order: 74
sourcePath: "javascript/crypto.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:crypto`](/runtime/docs/javascript/crypto/)

[`oro:crypto`](/runtime/docs/javascript/crypto/) exposes hashing, random bytes, and bundled sodium-backed helpers.

## Related guides

- [Secure storage and sessions](/runtime/docs/guides/secure-storage-and-sessions/)
