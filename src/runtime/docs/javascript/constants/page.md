...
section: "javascript"
order: 72
sourcePath: "javascript/constants.md"
...
[`oro:constants`](/runtime/docs/javascript/constants/) publishes the runtime’s platform, errno, and low-level constant tables.
