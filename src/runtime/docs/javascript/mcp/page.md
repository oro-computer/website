...
[`oro:mcp`](/runtime/docs/javascript/mcp/) provides runtime MCP helpers for registering tools/resources and controlling the embedded HTTP/SSE bridge.

If you want the CLI-hosted server for a workspace, see: [`oroc mcp`](/runtime/docs/cli/mcp/).
