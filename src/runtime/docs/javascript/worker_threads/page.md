...
section: "javascript"
order: 127
sourcePath: "javascript/worker_threads.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:worker_threads`](/runtime/docs/javascript/worker_threads/)

[`oro:worker_threads`](/runtime/docs/javascript/worker_threads/) exposes worker-thread primitives, ports, and environment data helpers.
