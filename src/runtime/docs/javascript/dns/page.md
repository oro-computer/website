...
section: "javascript"
order: 79
sourcePath: "javascript/dns.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:dns`](/runtime/docs/javascript/dns/)

[`oro:dns`](/runtime/docs/javascript/dns/) provides DNS lookup helpers and promise-based resolution APIs.
