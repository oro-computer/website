...
section: "javascript"
order: 67
sourcePath: "javascript/child_process.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:child_process`](/runtime/docs/javascript/child_process/)

[`oro:child_process`](/runtime/docs/javascript/child_process/) launches and manages subprocesses with a Node-compatible API.
