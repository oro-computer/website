...
section: "javascript"
order: 78
sourcePath: "javascript/did.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:did`](/runtime/docs/javascript/did/)

[`oro:did`](/runtime/docs/javascript/did/) parses and manipulates decentralized identifiers and DID URLs.
