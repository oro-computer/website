...
section: "javascript"
order: 103
sourcePath: "javascript/npm.md"
githubRepo: "oro-computer/runtime"
githubRef: "master"
---

# [`oro:npm/*`](/runtime/docs/javascript/npm/)

[`oro:npm/*`](/runtime/docs/javascript/npm/) supports package-resolution and service-worker plumbing for NPM-backed modules.
