...
section: "cli"
order: 10
sourcePath: "cli/environment-and-files.md"
...
This page collects every environment variable and important filesystem location used by [`sage`](/sage/docs/cli/sage/).
...
Unless `find_cmd` is configured, [`sage`](/sage/docs/cli/sage/) chooses the first available tool:
