...
This page documents every public CLI flag on [`sage`](/sage/docs/cli/sage/).
...
- when syntax highlighting is active, [`sage`](/sage/docs/cli/sage/) disables content-SGR pass-through to avoid mixing two SGR streams
...
Load order and precedence are covered in [Configuration](/sage/docs/cli/configuration/).
