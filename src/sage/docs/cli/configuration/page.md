...
section: "cli"
order: 8
sourcePath: "cli/configuration.md"
...
[`sage`](/sage/docs/cli/sage/) reads configuration from `.sagerc`, a TOML file.

## Load order

If `--rc PATH` is provided, [`sage`](/sage/docs/cli/sage/) reads that file.
