...
section: "cli"
order: 9
sourcePath: "cli/syntax-and-cache.md"
...
[`sage`](/sage/docs/cli/sage/) can apply syntax highlighting to local paths and URL-backed content.
...
When syntax highlighting is enabled, [`sage`](/sage/docs/cli/sage/) chooses a syntax key in this order:
...
- if the path is not informative, [`sage`](/sage/docs/cli/sage/) may use `Content-Type`
...
[`sage`](/sage/docs/cli/sage/) also supports bundled syntax caches in distributable layouts:
