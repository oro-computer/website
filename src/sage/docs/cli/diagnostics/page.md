...
- [`sage`](/sage/docs/cli/sage/) continues running

Fix:

- validate the TOML
- compare against [Configuration](/sage/docs/cli/configuration/)
...
When `stdout` is not a TTY, [`sage`](/sage/docs/cli/sage/) enters a streaming branch instead of the TUI. Current behavior to understand:
