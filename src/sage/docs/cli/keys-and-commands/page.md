...
section: "cli"
order: 7
sourcePath: "cli/keys-and-commands.md"
...
This is the full interactive key and command reference for [`sage`](/sage/docs/cli/sage/).
...
For local files, [`sage`](/sage/docs/cli/sage/) shells out to the configured or default external find tool. For URL-backed tabs, the content is resolved through the URL handling path.

See [Syntax and cache](/sage/docs/cli/syntax-and-cache/) and [Environment and files](/sage/docs/cli/environment-and-files/) for `find_cmd`.
