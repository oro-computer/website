...
This guide covers the downstream story: build [`sage`](/sage/docs/cli/sage/), install it, page real inputs, then move into configuration and plugins.

## Build from source

From a checkout of the [`sage`](/sage/docs/cli/sage/) repository:
...
## What [`sage`](/sage/docs/cli/sage/) accepts

[`sage`](/sage/docs/cli/sage/) accepts:
...
See [Inputs and modes](/sage/docs/cli/inputs-and-modes/) for the exact behavior and edge cases.
...
See the full reference in [Keys and commands](/sage/docs/cli/keys-and-commands/).
...
See [Configuration](/sage/docs/cli/configuration/) and [Syntax and cache](/sage/docs/cli/syntax-and-cache/).

## Next

- Adopt it in shell workflows: [Pager workflows](/sage/docs/guides/pager-workflows/)
- Tune the CLI surface: [Options](/sage/docs/cli/options/)
- Add automation: [Plugins quickstart](/sage/docs/guides/plugins-quickstart/)
