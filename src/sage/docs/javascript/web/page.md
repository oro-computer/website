...
[`sage:core/web`](/sage/docs/javascript/web/) provides a host-free, in-memory set of WHATWG-style web primitives.
...
Converts a `Request` instance into the host wire shape used by [`sage:fetch`](/sage/docs/javascript/fetch/).
