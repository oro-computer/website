...
section: "man"
order: 28
sourcePath: "man/sage-1.md"
githubRepo: "oro-computer/sage"
githubRef: "master"
---

# [`sage(1)`](/sage/docs/man/sage-1/)

[`sage(1)`](/sage/docs/man/sage-1/) is the command reference for the pager itself. This page mirrors the man page in website form so downstream readers do not have to context-switch into `man`.
...
## What [`sage(1)`](/sage/docs/man/sage-1/) defines
...
[`sage(1)`](/sage/docs/man/sage-1/) is the authoritative option list for:
...
Read the fuller website breakdown in [Options](/sage/docs/cli/options/).

### Keybindings and command mode

[`sage(1)`](/sage/docs/man/sage-1/) defines:
...
Read the fuller website breakdown in [Keys and commands](/sage/docs/cli/keys-and-commands/).
...
- [CLI overview (`sage`)](/sage/docs/cli/sage/)
- [Inputs and modes](/sage/docs/cli/inputs-and-modes/)
- [Options](/sage/docs/cli/options/)
- [Keys and commands](/sage/docs/cli/keys-and-commands/)
- [Configuration](/sage/docs/cli/configuration/)
- [Environment and files](/sage/docs/cli/environment-and-files/)
- [Diagnostics](/sage/docs/cli/diagnostics/)
