...
section: "man"
order: 15
sourcePath: "man/virtnosis-agent-1.md"
...
[`virtnosis-agent`](/virtnosis/docs/cli/virtnosis-agent/) — Virtnosis local agent and daemon
...
[`virtnosis-agent`](/virtnosis/docs/cli/virtnosis-agent/) starts the Virtnosis control-plane daemon. It binds a local
