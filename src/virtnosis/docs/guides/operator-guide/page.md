...
section: "guides"
order: 3
sourcePath: "guides/operator-guide.md"
...
Public [`vnactl`](/virtnosis/docs/cli/vnactl/) builds do not expose separate fail-policy flags.
...
- check whether [`vnactl`](/virtnosis/docs/cli/vnactl/) has fallen back from a missing rootless socket to `/run/virtnosis/agent.sock`
...
- do not mix [`virtnosis-agent`](/virtnosis/docs/cli/virtnosis-agent/) and [`vnactl`](/virtnosis/docs/cli/vnactl/) from different installs or build generations; align `PATH` or reinstall so they match

For the detailed status/build-identity field contract, use
[Output and Automation](/virtnosis/docs/guides/output-and-automation/). For deployment and
socket-selection behavior, use [Deployment Guide](/virtnosis/docs/guides/deployment/).
...
- What the scanner checks: [Scan Analysis](/virtnosis/docs/reference/scan-analysis/)
- Stable fields and exit behavior: [Output and Automation](/virtnosis/docs/guides/output-and-automation/)
- Agent deployment and permissions: [Deployment Guide](/virtnosis/docs/guides/deployment/)
