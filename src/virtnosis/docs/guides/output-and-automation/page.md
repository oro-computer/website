...
section: "guides"
order: 6
sourcePath: "guides/output-and-automation.md"
...
- What is being scanned: [Scan Analysis](/virtnosis/docs/reference/scan-analysis/)
- Operator workflows: [Operator Guide](/virtnosis/docs/guides/operator-guide/)
- Protocol and product structure: [Architecture](/virtnosis/docs/reference/architecture/)
