...
section: "reference"
order: 12
sourcePath: "reference/development.md"
...
- [`src/virtnosis/libvirt/`](https://github.com/oro-computer/virtnosis/tree/master/src/virtnosis/libvirt/) — low-level libvirt RPC and transport
- [`src/virtnosis/scan/`](https://github.com/oro-computer/virtnosis/tree/master/src/virtnosis/scan/) — scan extraction, risk logic, and output helpers
- [`src/virtnosis/agent/`](https://github.com/oro-computer/virtnosis/tree/master/src/virtnosis/agent/) — agent socket, auth, transport policy, and control helpers
- [`src/virtnosis/output/`](https://github.com/oro-computer/virtnosis/tree/master/src/virtnosis/output/) — record capture and report wrapping
- [`src/entry_impl.slk`](https://github.com/oro-computer/virtnosis/blob/master/src/entry_impl.slk) — main entry implementation for scanner and agent
- [`src/vnactl.slk`](https://github.com/oro-computer/virtnosis/blob/master/src/vnactl.slk) — client CLI
- [`src/virtnosis/cli.slk`](https://github.com/oro-computer/virtnosis/blob/master/src/virtnosis/cli.slk) — shared CLI parsing and usage text

## Silk-specific notes

Authoritative Silk and stdlib observations for this repo live in the repository
notes tracked in [Repository documents](/virtnosis/docs/reference/repository-docs/).
...
- Product and operator docs: [Start](/virtnosis/docs/) and [Overview](/virtnosis/docs/reference/overview/)
- Technical design target and internal engineering notes: [Repository documents](/virtnosis/docs/reference/repository-docs/)
