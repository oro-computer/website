...
section: "reference"
order: 10
sourcePath: "reference/scan-analysis.md"
...
- Stable output fields: [Output and Automation](/virtnosis/docs/guides/output-and-automation/)
- User workflows: [Operator Guide](/virtnosis/docs/guides/operator-guide/)
- Technical design: [Architecture](/virtnosis/docs/reference/architecture/)
