...
- [`virtnosis-agent`](/virtnosis/docs/cli/virtnosis-agent/) — long-running local control-plane daemon
- [`vnactl`](/virtnosis/docs/cli/vnactl/) — client CLI for the agent

## When to use each binary

### [`virtnosis-agent`](/virtnosis/docs/cli/virtnosis-agent/) + [`vnactl`](/virtnosis/docs/cli/vnactl/)
...
- First run: [Getting Started](/virtnosis/docs/guides/getting-started/)
- Daily use: [Operator Guide](/virtnosis/docs/guides/operator-guide/)
- Deeper semantics: [Scan Analysis](/virtnosis/docs/reference/scan-analysis/)
- Protocol and product design: [Architecture](/virtnosis/docs/reference/architecture/)
