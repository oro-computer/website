...
section: "cli"
order: 6
sourcePath: "cli/traversal-and-ignores.md"
...
This page documents exactly what [`slg`](/slg/docs/cli/slg/) walks, skips, and re-enables.
...
By default, [`slg`](/slg/docs/cli/slg/) enables all three ignore sources:
