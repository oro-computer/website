...
section: "cli"
order: 5
sourcePath: "cli/patterns-and-matching.md"
...
This page documents how [`slg`](/slg/docs/cli/slg/) interprets patterns once parsing is complete.
...
Patterns that contain no regex metacharacters are automatically handled by the fixed matcher currently.
...
[`slg`](/slg/docs/cli/slg/) searches one line at a time.
...
By default, [`slg`](/slg/docs/cli/slg/) skips files that look binary.
...
See [Diagnostics](/slg/docs/cli/diagnostics/).
