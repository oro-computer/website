...
[`slg`](/slg/docs/cli/slg/) can traverse and search in parallel, but the control surface is explicit and intentionally bounded.
...
The implementation clamps large values to keep the parallel engine bounded.
