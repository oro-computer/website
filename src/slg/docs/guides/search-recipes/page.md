...
section: "guides"
order: 2
sourcePath: "guides/search-recipes.md"
...
These are practical [`slg`](/slg/docs/cli/slg/) workflows for code trees, logs, and large repositories.
...
When the pattern has no regex metacharacters, [`slg`](/slg/docs/cli/slg/) automatically uses the fixed matcher. This is the implementation behavior even without `-F`.
...
By default, [`slg`](/slg/docs/cli/slg/) skips files that contain a NUL byte in the first 1024 bytes.
