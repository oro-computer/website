...
This guide covers the downstream story: build [`slg`](/slg/docs/cli/slg/), install it, run a few real searches, then move into the exact CLI reference.

## Build from source

From a checkout of the [`slg`](/slg/docs/cli/slg/) repository:
...
## How to think about [`slg`](/slg/docs/cli/slg/)
...
The website version is here: [`slg(1)`](/slg/docs/man/slg-1/)

## Next

- Exact CLI shape: [`slg`](/slg/docs/cli/slg/)
- Root/path behavior: [Input types and parsing](/slg/docs/cli/input-types-and-parsing/)
- Common workflows: [Search recipes](/slg/docs/guides/search-recipes/)
