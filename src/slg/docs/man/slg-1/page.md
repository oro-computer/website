...
section: "man"
order: 11
sourcePath: "man/slg-1.md"
githubRepo: "oro-computer/slg"
githubRef: "master"
---

# [`slg`](/slg/docs/cli/slg/) (1) — Silk Line Grep

This page is the reader-friendly website form of the shipped `slg(1)` manual.

## Name

[`slg`](/slg/docs/cli/slg/) — Silk Line Grep, a fast recursive file + pattern search tool
...
[`slg`](/slg/docs/cli/slg/) recursively walks directory trees and either:
...
- when a pattern contains no regex metacharacters, [`slg`](/slg/docs/cli/slg/) automatically uses the fixed matcher
...
[`slg`](/slg/docs/cli/slg/) does not currently read a runtime config file.
...
- [Input types and parsing](/slg/docs/cli/input-types-and-parsing/)
- [Patterns and matching](/slg/docs/cli/patterns-and-matching/)
- [Traversal and ignores](/slg/docs/cli/traversal-and-ignores/)
- [Options reference](/slg/docs/cli/options-reference/)
