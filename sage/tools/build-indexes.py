...
PINNED_ORDER = [
    ...
    "guides/pager-workflows",
    "guides/plugins-quickstart",
    # CLI
    "cli/sage",
    "cli/inputs-and-modes",
    "cli/options",
    "cli/keys-and-commands",
    "cli/configuration",
    "cli/syntax-and-cache",
    "cli/environment-and-files",
    "cli/diagnostics",
    # JavaScript APIs
    "javascript/overview",
    "javascript/runtime",
