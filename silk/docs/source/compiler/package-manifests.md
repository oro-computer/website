...
defined in [packages imports exports](?p=language/packages-imports-exports).
...
See [build scripts](?p=compiler/build-scripts).
...
- Definition files SHOULD consist of:
 ...
 See [packages imports exports](?p=language/packages-imports-exports) (“Prototype exports”).
...
- When a build module is executed:
 ...
 build (see [build scripts](?p=compiler/build-scripts)),
