...
Source: `std/runtime/event_loop.slk`

This is the exact canonical documentation page for `std::runtime::event_loop`.

## Role

`std::runtime::event_loop` is an implementation-facing runtime module in the shipped `std/**` tree.
...
- The shipped source for this module is `std/runtime/event_loop.slk`.
- The canonical module name is `std::runtime::event_loop`.
