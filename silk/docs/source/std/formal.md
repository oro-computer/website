...
See [formal verification](?p=language/formal-verification) for the Formal Silk execution model
and theory semantics.

When `std::formal` is built and packaged as distributable Silk surface, its
