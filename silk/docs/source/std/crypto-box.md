...
Source: `std/crypto/box.slk`

This is the exact canonical documentation page for `std::crypto::box`.

## Role

`std::crypto::box` is a shipped nested module in the Silk standard library.
...
- The shipped source for this module is `std/crypto/box.slk`.
- The canonical module name is `std::crypto::box`.
