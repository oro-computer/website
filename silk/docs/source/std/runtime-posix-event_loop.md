# `std::runtime::posix::event_loop`

Source: `std/runtime/posix/event_loop.slk`

This is the exact canonical documentation page for `std::runtime::posix::event_loop`.

## Role

`std::runtime::posix::event_loop` is an implementation-facing runtime module in the shipped `std/**` tree.
...
- The shipped source for this module is `std/runtime/posix/event_loop.slk`.
- The canonical module name is `std::runtime::posix::event_loop`.
