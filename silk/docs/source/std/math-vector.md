...
Source: `std/math/vector.slk`

This is the exact canonical documentation page for `std::math::vector`.

## Role

`std::math::vector` is a shipped nested module in the Silk standard library.
...
- The shipped source for this module is `std/math/vector.slk`.
- The canonical module name is `std::math::vector`.
