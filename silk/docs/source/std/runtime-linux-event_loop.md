# `std::runtime::linux::event_loop`

Source: `std/runtime/linux/event_loop.slk`

This is the exact canonical documentation page for `std::runtime::linux::event_loop`.

## Role

`std::runtime::linux::event_loop` is an implementation-facing runtime module in the shipped `std/**` tree.
...
- The shipped source for this module is `std/runtime/linux/event_loop.slk`.
- The canonical module name is `std::runtime::linux::event_loop`.
