...
Source: `std/runtime/mem.slk`

This is the exact canonical documentation page for `std::runtime::mem`.

## Role

`std::runtime::mem` is an implementation-facing runtime module in the shipped `std/**` tree.
...
- The shipped source for this module is `std/runtime/mem.slk`.
- The canonical module name is `std::runtime::mem`.
