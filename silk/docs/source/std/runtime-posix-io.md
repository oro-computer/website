# `std::runtime::posix::io`

Source: `std/runtime/posix/io.slk`

This is the exact canonical documentation page for `std::runtime::posix::io`.

## Role

`std::runtime::posix::io` is an implementation-facing runtime module in the shipped `std/**` tree.
...
- The shipped source for this module is `std/runtime/posix/io.slk`.
- The canonical module name is `std::runtime::posix::io`.
