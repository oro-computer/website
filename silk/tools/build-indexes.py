...
LANGUAGE_ORDER = [
    ...
    "language/gpu-execution",
    "language/gpu-launch-blocks",
...
USAGE_ORDER = [
    ...
    "usage/howto-dynamic-libraries",
    "usage/howto-run-wasi-node",
    "usage/pure-silk-gpu",
    "usage/pure-silk-gpu-ml",
    "usage/howto-lumen-trail",
...
COMPILER_ORDER = [
    ...
    "compiler/builtin-deps",
    "compiler/stdlib-integration",
    "compiler/backend-gpu",
    "compiler/backend-amdgpu",
    "compiler/backend-nvidia",
...
MAN_ORDER = [
    ...
    "man/silk_amdgpu_aql_dispatch_packet_build.3",
]
