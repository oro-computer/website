...
PINNED_ORDER = [
    ...
    "guides/install-and-package",
    "guides/operator-guide",
    "guides/deployment",
    "guides/systemd",
    "guides/output-and-automation",
    # CLI
    "cli/vnactl",
    "cli/virtnosis-agent",
    # Reference
    "reference/overview",
    "reference/scan-analysis",
    "reference/architecture",
    "reference/development",
    "reference/repository-docs",
    # Man pages
    "man/vnactl-1",
    "man/virtnosis-agent-1",
    "man/virtnosis-7",
    "man/virtnosis-agent-protocol-7",
    "man/virtnosis-scan-report-7",
]
